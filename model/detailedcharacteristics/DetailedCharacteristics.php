...
require_once('AdditionalAppliances.php');
require_once('CoolingSystems.php');
require_once('HeatingSystems.php');
require_once('OtherAmenities.php');
require_once('ParkingTypes.php');
...
class DetailedCharacteristics extends Element {
    ...
    public function getAdditionalAppliances() {
        return $this->additional_appliances;
    }
